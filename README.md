...
# İŞ FIRSATI DOĞMA İHTİMALİNDEN DOLAYI ROADMAP'TE UFAK DÜZENLEME 
Seri şekilde C++, ROS2, Gazebo... öğrenmem gerekiyor. 

<mark> C →  C++ + CMAKE + LINUX + GIT →</mark> ROS2 → LOW LEVEL C / MEMORY MANAGEMENT DEBUGGING → EMBEDDED / MCU / ARM →  RTOS/FREETOS + OS
